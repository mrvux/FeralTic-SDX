...
{
    public class TextExtrudingSink : GeometrySink, TessellationSink
    {
        private List<Pos3Norm3Vertex> vertices;


        public TextExtrudingSink(List<Pos3Norm3Vertex> vertices, float height)
        {
        ...
        public void EndFigure(FigureEnd figureEnd)
        {
            ...
            if (m_figureVertices.Count > 1)
            {
                ...
                for (int i = 0; i < m_figureVertices.Count; i++)
                {
                    ...
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(pt.X, pt.Y, m_height / 2), Normals = new Vector3(ptNorm3.X, ptNorm3.Y, 0.0f) });
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(pt.X, pt.Y, -m_height / 2), Normals = new Vector3(ptNorm3.X, ptNorm3.Y, 0.0f) });
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(nextPt.X, nextPt.Y, -m_height / 2), Normals = new Vector3(nextPtNorm2.X, nextPtNorm2.Y, 0.0f) });
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(nextPt.X, nextPt.Y, -m_height / 2), Normals = new Vector3(nextPtNorm2.X, nextPtNorm2.Y, 0.0f) });
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(nextPt.X, nextPt.Y, m_height / 2), Normals = new Vector3(nextPtNorm2.X, nextPtNorm2.Y, 0.0f) });
                    vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(pt.X, pt.Y, m_height / 2), Normals = new Vector3(ptNorm3.X, ptNorm3.Y, 0.0f) });
        ...
        public void AddTriangles(Triangle[] triangles)
        {
            for (int i = 0; i < triangles.Length; i++)
            {
                ...
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point1.X, tri.Point1.Y, m_height / 2), Normals = new Vector3(0.0f, 0.0f, 1.0f) });
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point2.X, tri.Point2.Y, m_height / 2), Normals = new Vector3(0.0f, 0.0f, 1.0f) });
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point3.X, tri.Point3.Y, m_height / 2), Normals = new Vector3(0.0f, 0.0f, 1.0f) });
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point2.X, tri.Point2.Y, -m_height / 2), Normals = new Vector3(0.0f, 0.0f, -1.0f) });
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point1.X, tri.Point1.Y, -m_height / 2), Normals = new Vector3(0.0f, 0.0f, -1.0f) });
                vertices.Add(new Pos3Norm3Vertex() { Position = new Vector3(tri.Point3.X, tri.Point3.Y, -m_height / 2), Normals = new Vector3(0.0f, 0.0f, -1.0f) });
            }
